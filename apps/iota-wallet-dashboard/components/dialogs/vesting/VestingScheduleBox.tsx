...
import { formatDate, useFormatCoin, useGetClockTimestamp } from "@repo/iota-core";
...
export function VestingScheduleBox({ amount, expirationTimestampMs }: VestingScheduleBoxProps): React.JSX.Element {
  ...
  const transactionDate = formatDate(Number(expirationTimestampMs), ["day", "month", "year", "hour", "minute"]);
  return (
    <DisplayStats
