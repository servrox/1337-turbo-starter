...
import { Card, CardAction, CardActionType, CardBody, CardImage, CardType, Header, ImageType } from "@iota/apps-ui-kit";
import { ToS_LINK, toTitleCase } from "@repo/iota-core";
            ...
            {MENU_ITEMS.map((item, index) => (
              <Card key={index} type={CardType.Default} onClick={item.onClick}>
                <CardImage type={ImageType.BgSolid}>
                  <div className="text-iota-neutral-10 dark:text-iota-neutral-92 flex h-10 w-10 items-center justify-center rounded-full [&_svg]:h-5 [&_svg]:w-5">
