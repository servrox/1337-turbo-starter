...
import { useIsValidatorCommitteeMember, Validator } from "@repo/iota-core";
...
export function SelectValidatorView({
  ...
  const committeeMemberValidators = filteredValidators.filter((validator) => isCommitteeMember(validator.iotaAddress));
