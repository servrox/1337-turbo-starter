...
import { formatPercentageDisplay, useGetStakingValidatorDetails, useValidatorInfo } from "@repo/iota-core";
...
export function StakedInfo({ validatorAddress, accountAddress }: StakedInfoProps) {
  ...
  const { totalValidatorsStake, totalStakePercentage, totalStake, commission } = useGetStakingValidatorDetails({
